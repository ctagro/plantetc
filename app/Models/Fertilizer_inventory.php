...
class Fertilizer_inventory extends Model
{
    use SoftDeletes;
    ...
    public function storeFertilizer_inventory(array $data): Array
    {
 ...
 // recebe o array do controller Despesa -> storeDespesa e grava na tabela
            ...
            $fertilizer_inventory = auth()->user()->Fertilizer_inventory()->create([
