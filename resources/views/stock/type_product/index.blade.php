                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            Tipo de atividades
                           <a class="float-right" href="{{url('type_product/create')}}">Cadastrar</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                      @foreach($type_products as $type_product)
                        ...
                        <tr>
                          ...
                          <td>  
                          <a href= "{{ route('type_product.edit' ,[ 'type_product' => $type_product->id  ])}}" >{{ $type_product -> name}}</a>
                          </td>
                          <td>
                            <textarea class="form-control" rows="2" cols= "33" > {{$type_product->note }} </textarea>
                          </td>
        
                          <td >
            
                            <form id="delete-form"  method="POST" action="{{ route('type_product.destroy' ,[ 'type_product' => $type_product->id ])}}", style = 'display: inline;'> 
                              {{ csrf_field() }}
                              {{ method_field('DELETE') }}                 
                            </form>
                          </td>
