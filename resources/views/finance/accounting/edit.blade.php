...
@endif
    ...
    <!-- porque nao suporta o metodo POST se store é post-->
        <form action="{{ route('accounting.update' ,[ 'accounting' => $accounting->id ])}}" method="POST"  enctype="multipart/form-data">
        ...
        <form action="{{ route('accounting.show' ,[ 'accounting' => $accounting->id ])}}" method="POST"  enctype="multipart/form-data">
