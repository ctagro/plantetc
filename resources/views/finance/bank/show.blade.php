...
<div class="container">
  <div class="row justify-content-center">
   ...
   <form action="{{ route('bank.destroy',[ 'bank' => $bank->id ])}}" method="POST"  enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class="container">
        ...
        <div class="row">
          <div class="form-control">{{ $bank->name}}</div>
        </div>
        <br>
        <div class="bg-light">Observação</div>
        <div class="row">
            <textarea class="form-control" rows="3" >{{$bank->note }} </textarea>
        </div>
        <br>
    </div>
