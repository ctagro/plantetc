...
@endif
    ...
    <!-- porque nao suporta o metodo POST se store é post-->
        <form action="{{ route('bank.update' ,[ 'bank' => $bank->id ])}}" method="POST"  enctype="multipart/form-data">
        ...
        <form action="{{ route('bank.show' ,[ 'bank' => $bank->id ])}}" method="POST"  enctype="multipart/form-data">
