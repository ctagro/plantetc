     ...
     <input type="hidden" name="user_id" value="{{auth()->user()->id}}" class="form-control py-3"> 
            ...
            <div class="form-group">
                ...
                @if($errors->has('accounting_id'))
                    <h6 class="text-danger" >Selecione o comprador</h6> 
                @endif
            </div>
...
<input type="hidden" name="type_account_id" value="{{old('type_account_id') ? $account->type_account_id : 3 }}" class="form-control py-3">
