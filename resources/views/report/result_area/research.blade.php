...
<form method="POST" action="{{ route('result_area.research')}}">
  
             <div class="form-group">
             {!! csrf_field() !!}                      

             @include('report.result_area.form')

             <div class="form-group">
              <button type="submit" class="btn btn-danger btn-block">Elaborar relatório</button>
         </div>
     </div>
     <div class="card">
      <div class="card-header">
