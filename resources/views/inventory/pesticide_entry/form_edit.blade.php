     ...
     <input type="hidden" name="type_product_id" value="2" class="form-control py-3"> 
            ...
            <div class="form-group row">
                ...
                <select name="pesticide_id"  id="pesticide_id" class="form-control">
                    <option value="" disabled selected>Selecione o defensivo...</option> 
                ...
                <div class="form-group row">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-3 ">
                            ...
                            <input type="number" class="form-control py-3" name="quantity" value="{{old('quantity') ?? $pesticide_entry->quantity }}"  placeholder="0.00" step="0.01" >
                        ...
                        <div class="form-group col-sm-3 ">
                            ...
                            <input type="number" class="form-control py-3" name="price_unit" value="{{old('price_unit') ?? $pesticide_entry->price_unit }}"  placeholder="0.0000" step="0.0001" >
                        ...
                        <div class="form-group col-sm-3 ">
                            ...
                            <input type="number" class="form-control py-3" name="amount" value="{{old('amount') ?? $pesticide_entry->amount }}"  placeholder="0.00" step="0.01" >
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-3 ">
                            ...
                            <input type="number" name="quantity_cons"  class="form-control py-3" name="quantity_cons" value="{{old('quantity_cons') ?? $pesticide_entry->quantity_cons }}"placeholder="0.00" step="0.01" >
                        ...
                        <div class="form-group col-sm-3 ">
                            ...
                            <input type="number" name="price_unit_cons"  class="form-control py-3" name="price_unit_cons" value="{{old('price_unit_cons') ?? $pesticide_entry->price_unit_cons }}"placeholder="0.0000" step="0.0001" >
