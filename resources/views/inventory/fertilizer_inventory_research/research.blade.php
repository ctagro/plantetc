            ...
            <div class="card">
                <div class="card-header">
                  <img class="card-img-top img-responsive img-thumbnail" src="{{ asset('img/cards/inventory_plant.png')}}"  style="height: 50px; width: 50px;"alt="Imagem" >
                    Pesquisar novimentação de estoque de fertilizantes
                </div>
            </div>
        </div>
    </div>
...
<form method="POST" action="{{ route('fertilizer_inventory_research.research')}}">
  
             <div class="form-group">
             {!! csrf_field() !!}                      

             @include('inventory.fertilizer_inventory_research.form')
